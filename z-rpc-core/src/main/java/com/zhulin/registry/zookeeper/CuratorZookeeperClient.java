...
public class CuratorZookeeperClient extends AbstractZookeeperClient {
    ...
    public String getNodeData(String path) {
        try {
            byte[] results = client.getData().forPath(path);
            if (results != null) {
    ...
    public void createPersistentData(String address, String data) {
        try {
            client.create().creatingParentContainersIfNeeded().withMode(CreateMode.PERSISTENT).forPath(address,
                    data.getBytes());
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    public void createTemporaryData(String address, String data) {
        try {
            client.create().creatingParentContainersIfNeeded().withMode(CreateMode.EPHEMERAL).forPath(address,
                    data.getBytes());
